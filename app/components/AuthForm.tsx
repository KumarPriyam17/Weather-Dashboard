        ...
        <div className="w-full max-w-md p-8 rounded-2xl glass-panel relative overflow-hidden">
            ...
            <div className="mb-8 text-center">
                ...
                <p className="text-white/60 text-sm">
                    {isLogin ? 'Enter your details to access your dashboard' : 'Sign up to start tracking weather'}
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-white/80 text-sm font-medium mb-1 ml-1">Email</label>
                        <input
                            type="email"
                            value={email}
